...
if grep -q "wp_enqueue_style.*tbmx-megamenu" "$PLUGIN_DIR/includes/class-assets.php"; then
...
if grep -q "wp_enqueue_script.*tbmx-megamenu" "$PLUGIN_DIR/includes/class-assets.php"; then
